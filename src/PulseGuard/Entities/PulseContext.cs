...
{
    public required TableSet<PulseConfiguration> Configurations { get; init; }
    public required TableSet<Pulse> Pulses { get; init; }
    public required TableSet<UniqueIdentifiers> UniqueIdentifiers { get; init; }
    public required TableSet<Webhook> Webhooks { get; init; }
}
